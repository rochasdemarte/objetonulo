...
// Final render segmentation - Data to canvas context.
...
function enableCam(event) {
  ...
  let videoSettings = isMobile ? { facingMode: { exact: "environment" }} : true;
